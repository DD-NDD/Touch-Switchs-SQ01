...
# 184 "mcc_generated_files/mtouch/../pin_manager.h"
void PIN_MANAGER_Initialize (void);
# 196 "mcc_generated_files/mtouch/../pin_manager.h"
...
static mtouch_scan_group_t const sensor_scan_group[1u] = {
    { ((void*)0) ,&(mtouch_sensor[Sensor_AN23])},
};
...
# 241 "mcc_generated_files/mtouch/mtouch_sensor.c"
_Bool MTOUCH_Sensor_SampleAll(void)
{
    uint8_t group;
...
# 671 "mcc_generated_files/mtouch/mtouch_sensor.c"
static void Sensor_autoCalibration(mtouch_sensor_t* sensor)
{
    uint8_t adcIndex = Sensor_getScanGroupIndex(sensor);
...
# 716 "mcc_generated_files/mtouch/mtouch_sensor.c"
static enum mtouch_sensor_error Sensor_Scanfrequency_Evaluation(mtouch_sensor_t* sensor_adc1,mtouch_sensor_t* sensor_adc2)
{
    uint8_t i;
...
# 855 "mcc_generated_files/mtouch/mtouch_sensor.c"
static __attribute__((inline)) void Sensor_setActive(mtouch_sensor_t* sensor)
{
    sensor->active = 1;
}
...
# 887 "mcc_generated_files/mtouch/mtouch_sensor.c"
void MTOUCH_Sensor_Calibrate(enum mtouch_sensor_names sensor)
{
    if(sensor < 1u)
    {
...
# 933 "mcc_generated_files/mtouch/mtouch_sensor.c"
void MTOUCH_Sensor_Sampled_ResetAll(void)
{
...
# 964 "mcc_generated_files/mtouch/mtouch_sensor.c"
